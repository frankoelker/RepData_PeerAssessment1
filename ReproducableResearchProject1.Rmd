...
hist(spd, main = "Histogram of the total number of steps taken each day", xlab = "Steps")
```
...
hist(stepFilled, main = "Histogram Steps per Day with filled data", xlab = "Steps")
```
...
Mean with NA:   `r mean`         Median with NA:    `r median`   
Mean without NA: `r meanFilled`  Median without NA: `r medianFilled`  
